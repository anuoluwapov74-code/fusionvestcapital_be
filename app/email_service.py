"""
Email service for FusionVest Capital
...
def _header_html():
    return """
    <div class="header">
        <div class="header-logo">FusionVest<span>Capital</span></div>
...
def _footer_html(user_email):
    ...
    <div class="footer">
        <div class="footer-text">
            This is an automated message from FusionVest Capital. Please do not reply directly to this email.
        </div>
        ...
        <div class="footer-text" style="margin-top: 16px;">
            Sent to {user_email} &middot; &copy; {timezone.now().year} FusionVest Capital. All rights reserved.
        </div>
    </div>
    """
...
def send_welcome_email(user):
    subject = "Welcome to FusionVest Capital"
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="body-content">
                ...
                <div class="text">
                    Thank you for choosing FusionVest Capital. Your account has been successfully registered and is ready for setup.
                </div>
...
def send_verification_code_email(user, code):
    subject = "Email Verification \u2014 FusionVest Capital"
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="body-content">
                ...
                <div class="notice">
                    <p><strong>Security:</strong> Never share this code with anyone. FusionVest Capital will never ask for your verification code via phone or chat.</p>
                </div>

                <div class="divider"></div>

                <div class="text" style="font-size: 13px; color: #94a3b8;">
                    If you did not create a FusionVest Capital account, you can safely ignore this email.
                </div>
            </div>
...
def send_2fa_code_email(user, code):
    subject = "Login Verification \u2014 FusionVest Capital"
...
def send_password_reset_email(user, token, uid):
    ...
    subject = "Password Reset \u2014 FusionVest Capital"
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="body-content">
                ...
                <div class="text">
                    We received a request to reset the password associated with your FusionVest Capital account. Click the button below to set a new password.
                </div>
