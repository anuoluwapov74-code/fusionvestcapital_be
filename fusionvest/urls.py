...
admin.site.site_header = "FusionVest Administration"
admin.site.site_title = "FusionVest Admin Portal"
admin.site.index_title = "Welcome to FusionVest Admin Portal"
