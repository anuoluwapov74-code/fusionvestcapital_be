"""
Django settings for fusionvest project.
...
MIDDLEWARE = [
    ...
    'fusionvest.middleware.AppendSlashMiddleware',
...
WSGI_APPLICATION = 'fusionvest.wsgi.application'
